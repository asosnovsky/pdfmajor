...
from pdfmajor.interpreter.PDFResourceManager import PDFResourceManager
from pdfmajor.interpreter.constants import LITERAL_PDF, LITERAL_TEXT, LITERAL_FONT
