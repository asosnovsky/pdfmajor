...
from pdfmajor.utils import Point, Bbox, INF
from pdfmajor.utils import apply_matrix_pt, mult_matrix
...
class PDFPageLayoutAnalyzer:
    ...
    def __init__(self, page: PDFPage, ctm: Tuple[float],  pageno: int=1):
        self.page = page
        self.pageno = pageno
        self._stack = []
        self.ctm = ctm
